...
function! nerdtree#loadClassFiles()
    ...
    runtime plugin/nerdtree/flag_set.vim
    runtime plugin/nerdtree/nerdtree.vim
    runtime plugin/nerdtree/ui.vim
    runtime plugin/nerdtree/event.vim
    runtime plugin/nerdtree/notifier.vim
endfunction
...
function! nerdtree#postSourceActions()
    ...
    runtime! plugin/nerdtree/scripts/*.vim
endfunction
